                  ...
                  <div className="space-y-6">
                    ...
                    <div className="p-4 bg-gradient-to-r from-green-50 to-indigo-50 rounded-xl border border-green-200">
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="flex justify-between items-center">
                          <span className="text-gray-700">Auto-split:</span>
                          <span className="font-semibold text-green-600 bg-green-100 px-2 py-1 rounded-full text-sm">Ready for group splitting</span>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              >
                <div className="card-header">
                  <div className="flex items-center gap-3">
                    ...
                    <h2 id="smart-insights-demo-title" className="text-2xl font-semibold text-gray-900">Spending Analytics</h2>
                  </div>
                </div>
                ...
                <div className="card-body">
                  <div className="space-y-6">
                    ...
                    <div className="p-4 bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl border border-green-200">
                      <div className="space-y-3">
                        <div className="text-sm text-green-600 font-medium">Category Breakdown:</div>
                        <div className="space-y-2">
                          <div className="flex justify-between items-center">
                            <span className="text-gray-700">Food & Dining:</span>
                            <span className="font-semibold text-green-600">$450 (36%)</span>
                          </div>
                          <div className="flex justify-between items-center">
                            <span className="text-gray-700">Transportation:</span>
                            <span className="font-semibold text-green-600">$300 (24%)</span>
                          </div>
                          <div className="flex justify-between items-center">
                            <span className="text-gray-700">Activities:</span>
                            <span className="font-semibold text-green-600">$200 (16%)</span>
                          </div>
                          <div className="flex justify-between items-center">
        ...
        <div className="container-pro">
          <div className="max-w-6xl mx-auto">
            <motion.div
              ...
              className="card-elevated mb-16"
              role="article"
              aria-labelledby="settlement-demo-title"
            >
              <div className="card-header">
                <div className="flex items-center gap-3">
                  ...
                  <h2 id="settlement-demo-title" className="text-2xl font-semibold text-gray-900">Easy Settlements</h2>
                </div>
              </div>
              ...
              <div className="card-body">
                <div className="space-y-6">
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="p-4 bg-gray-50 rounded-xl border border-gray-200">
                      <div className="text-sm text-gray-600 mb-3 font-medium">Current Balances:</div>
                      <div className="space-y-2">
                        <div className="flex justify-between items-center">
                          <span className="text-gray-700">John owes:</span>
                          <span className="font-semibold text-red-600">$125.50</span>
                        </div>
                        <div className="flex justify-between items-center">
                          <span className="text-gray-700">Sarah owes:</span>
                          <span className="font-semibold text-red-600">$89.25</span>
                        </div>
                        <div className="flex justify-between items-center">
                          <span className="text-gray-700">Mike owes:</span>
                          <span className="font-semibold text-green-600">+$214.75</span>
                        </div>
                      </div>
                    </div>
                    
                    <div className="p-4 bg-blue-50 rounded-xl border border-blue-200">
                      <div className="text-sm text-blue-600 mb-3 font-medium">Create Transfer:</div>
                      <div className="space-y-3">
                        <div className="text-sm text-gray-700">John → Mike: $125.50</div>
                        <div className="text-sm text-gray-700">Sarah → Mike: $89.25</div>
                        <div className="text-xs text-blue-600 mt-2">All balances settled!</div>
                      </div>
                    </div>
                  </div>
                </div>
